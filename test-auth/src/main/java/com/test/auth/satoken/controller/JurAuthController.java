...
public class JurAuthController {
	...
	public SaResult checkPermission() {
		...
		System.out.println(StpUtil.hasPermissionAnd("user.add", "user.delete", "user.get"));  // 指定多个，必须全部拥有才会返回 true
		System.out.println(StpUtil.hasPermissionOr("user.add", "user.delete", "user.get"));     // 指定多个，只要拥有一个就会返回 true
	...
	public SaResult checkRole() {
		...
		System.out.println(StpUtil.hasRoleAnd("admin", "ceo", "cfo"));  // 指定多个，必须全部拥有才会返回 true
		System.out.println(StpUtil.hasRoleOr("admin", "ceo", "cfo"));      // 指定多个，只要拥有一个就会返回 true
	...
	public SaResult wildcardPermission() {
		...
		System.out.println(StpUtil.hasPermission("art.add"));  // 返回 true
		System.out.println(StpUtil.hasPermission("art.delete"));  // 返回 true
		System.out.println(StpUtil.hasPermission("goods.add"));  // 返回 false，因为前缀不符合
		
		// * 符合可以出现在任意位置，比如权限码的开头，当账号拥有 "*.delete" 时  
		System.out.println(StpUtil.hasPermission("goods.add"));        // false
		System.out.println(StpUtil.hasPermission("goods.delete"));     // true
		System.out.println(StpUtil.hasPermission("art.delete"));      // true
		
		// 也可以出现在权限码的中间，比如当账号拥有 "shop.*.user" 时  
		System.out.println(StpUtil.hasPermission("shop.add.user"));  // true
		System.out.println(StpUtil.hasPermission("shop.delete.user"));  // true
		System.out.println(StpUtil.hasPermission("shop.delete.goods"));  // false，因为后缀不符合
